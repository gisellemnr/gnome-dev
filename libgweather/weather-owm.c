...
static struct owm_symbol {
    ...
    { 200, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_LIGHT, GWEATHER_DESCRIPTOR_THUNDERSTORM,
        GWEATHER_PRECIPITATION_RAIN, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Thunderstorm with light rain */
    { 201, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_THUNDERSTORM,
        GWEATHER_PRECIPITATION_RAIN, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Thunderstorm with rain */
    { 202, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_HEAVY, GWEATHER_DESCRIPTOR_THUNDERSTORM,
        GWEATHER_PRECIPITATION_RAIN, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Thunderstorm with heavy rain */
    { 210, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_LIGHT, GWEATHER_DESCRIPTOR_THUNDERSTORM,
        GWEATHER_PRECIPITATION_NONE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Light thunderstorm */
    { 211, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_THUNDERSTORM,
        GWEATHER_PRECIPITATION_NONE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Thunderstorm */
    { 212, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_HEAVY, GWEATHER_DESCRIPTOR_THUNDERSTORM,
        GWEATHER_PRECIPITATION_NONE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Heavy thunderstorm */
    { 221, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_THUNDERSTORM,
        GWEATHER_PRECIPITATION_NONE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Ragged thunderstorm */
    { 230, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_LIGHT, GWEATHER_DESCRIPTOR_THUNDERSTORM,
        GWEATHER_PRECIPITATION_DRIZZLE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Thunderstorm with light drizzle */
    { 231, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_THUNDERSTORM,
        GWEATHER_PRECIPITATION_DRIZZLE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Thunderstorm with drizzle */
    { 232, GWEATHER_SKY_OVERCAST,
      { TRUE, GWEATHER_INTENSITY_HEAVY, GWEATHER_DESCRIPTOR_THUNDERSTORM,
        GWEATHER_PRECIPITATION_DRIZZLE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Thunderstorm with heavy drizzle */

    { 300, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_LIGHT, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_DRIZZLE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Light intensity drizzle */
    { 301, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_DRIZZLE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Drizzle */
    { 302, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_HEAVY, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_DRIZZLE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Heavy intensity drizzle */
    { 310, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_LIGHT, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_DRIZZLE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Light intensity drizzle rain */
    { 311, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_DRIZZLE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Drizzle rain */
    { 312, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_HEAVY, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_DRIZZLE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Heavy intensity drizzle rain */
    { 321, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_SHOWERS,
        GWEATHER_PRECIPITATION_DRIZZLE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Drizzle showers */

    { 500, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_LIGHT, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_RAIN, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Light rain */
    { 501, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_MODERATE, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_RAIN, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Moderate rain */
    { 502, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_HEAVY, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_RAIN, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Heavy intensity rain */
    { 503, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_HEAVY, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_RAIN, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Very heavy rain */
    { 504, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_HEAVY, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_RAIN, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Extreme rain */
    { 511, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_FREEZING,
        GWEATHER_PRECIPITATION_RAIN, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Freezing rain */
    { 520, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_LIGHT, GWEATHER_DESCRIPTOR_SHOWERS,
        GWEATHER_PRECIPITATION_RAIN, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Light intensity shower rain */
    { 521, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_SHOWERS,
        GWEATHER_PRECIPITATION_RAIN, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Shower rain */
    { 522, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_HEAVY, GWEATHER_DESCRIPTOR_SHOWERS,
        GWEATHER_PRECIPITATION_RAIN, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Heavy intensity shower rain */

    { 600, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_LIGHT, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_SNOW, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Light snow */
    { 601, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_SNOW, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Snow */
    { 602, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_HEAVY, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_SNOW, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Heavy snow */
    { 611, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_ICE_PELLETS, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Sleet */
    { 621, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_SHOWERS,
        GWEATHER_PRECIPITATION_SNOW, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Shower snow */

    { 701, GWEATHER_SKY_CLEAR, 
      { TRUE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_NONE, GWEATHER_OBSCURATION_MIST, GWEATHER_OTHER_NONE } 
    }, /* Mist */
    { 711, GWEATHER_SKY_CLEAR, 
      { TRUE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_NONE, GWEATHER_OBSCURATION_SMOKE, GWEATHER_OTHER_NONE } 
    }, /* Smoke */
    { 721, GWEATHER_SKY_CLEAR, 
      { TRUE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_NONE, GWEATHER_OBSCURATION_HAZE, GWEATHER_OTHER_NONE } 
    }, /* Haze */
    { 731, GWEATHER_SKY_CLEAR, 
      { TRUE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_NONE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_DUST_WHIRLS } 
    }, /* Dust/sand whirls */
    { 741, GWEATHER_SKY_CLEAR, 
      { TRUE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_NONE, GWEATHER_OBSCURATION_FOG, GWEATHER_OTHER_NONE } 
    }, /* Fog */

    { 800, GWEATHER_SKY_CLEAR, 
      { FALSE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_NONE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Clear sky */
    { 801, GWEATHER_SKY_FEW, 
      { FALSE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_NONE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Few clouds */
    { 802, GWEATHER_SKY_SCATTERED, 
      { FALSE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_NONE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Scattered clouds */
    { 803, GWEATHER_SKY_BROKEN, 
      { FALSE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_NONE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Broken clouds */
    { 804, GWEATHER_SKY_OVERCAST, 
      { FALSE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_NONE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Overcast clouds */

    /* XXX: all these are a bit iffy */
    { 900, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_NONE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_TORNADO } 
    }, /* Tornado */
    { 901, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_NONE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_TORNADO } 
    }, /* Tropical storm */
    { 902, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_NONE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_TORNADO } 
    }, /* Hurricane */
    { 903, GWEATHER_SKY_CLEAR,
      { FALSE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_NONE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Cold */
    { 904, GWEATHER_SKY_CLEAR, 
      { FALSE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_NONE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Hot */
    { 905, GWEATHER_SKY_CLEAR, 
      { FALSE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_NONE,
        GWEATHER_PRECIPITATION_NONE, GWEATHER_OBSCURATION_NONE, GWEATHER_OTHER_NONE } 
    }, /* Windy */
    { 906, GWEATHER_SKY_OVERCAST, 
      { TRUE, GWEATHER_INTENSITY_NONE, GWEATHER_DESCRIPTOR_NONE,
